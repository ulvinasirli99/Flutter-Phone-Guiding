...
import 'package:flutterapp05182020/database/db_helper.dart';
import 'package:flutterapp05182020/model/contact.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        Stack(children: [
          Image.asset(
            contact.avatar == null ? "assets/image/download.png" : contact.avatar,
            fit: BoxFit.cover,
